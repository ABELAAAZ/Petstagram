...
const createComment = async (req, res, next) => {
   ...
   // http://localhost:4000/api/posts/${props.postId}/comment
    ...
    try {
        ...
        const error = new HttpError('Comment failed111, please try again', 500);
        return next(error);
    }
...
const deletecommentbyId = async (req, res, next) => {
    ...
    try {
        ...
        const error = new HttpError('Something went wrong, please try to update again111', 500);
        return next(error);
    };
...
if (!comment){
    ...
    try {
        ...
        const error = new HttpError('Something went wrong, please try to delete again', 500);
        return next(error);
    };
