...
const NewPost = () => {
  ...
  const postSubmitHandler = async event => {
    ...
    try {
      ...
      await sendRequest(`http://localhost:4000/api/posts`, 'POST', formData,{Authorization:'Bearer '+auth.token});
    ...
    <React.Fragment>
      ...
      <form className="place-form" onSubmit={postSubmitHandler}>
        ...
        <Input
          ...
          onInput={inputHandler}
        />
        <ImageUpload center id="image" onInput={inputHandler} errorText="Please upload a image" />
